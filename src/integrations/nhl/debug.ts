...
/**
 * Fetch current NHL standings and per-team stats from ESPN Core API.
 * Includes wins, losses, OT losses, total points, GF, GA, and averages.
 */
export async function fetchNHLTeamStats() {
  ...
  for (const entry of data.standings) {
    ...
    // Fetch team info (displayName, logo)
