...
//   /**
//    * Action: authenticate (username: String, password: String): { success: boolean } | (error: String)
//    *
...
//   /**
//    * Action: deleteAccount (username: String, password: String): { success: boolean } | (error: String)
//    *
//    * @requires: A User exists whose `username` matches the input `username`
//    *           and whose `password` matches the input `password`.
...
//   /**
//    * Action: changePassword (username: String, currentPass: String, newPass: String): { success: boolean } | (error: String)
//    *
//    * @requires: A User exists whose `username` matches the input `username`
...
//   /**
//    * Query: _checkPassword (username: String, password: String): { success: boolean } | { error: String }
//    *
