...
- Clear separation between **SportsStats**, **ItemTracking**, **PasswordAuth**, and **Sessioning** made the system stable and modular.

### Mistakes and Lessons
- Coded too quickly at first without planning dependencies or data flow.
- Learned to think ahead about concept responsibilities before implementing features.
...
- The biggest shift was restructuring how users could set specific stats for each sport for their tracked teams. I initially had this logic in the **SportsStats** concept, but I realized I could simplify that concept to just maintain statistics for teams and leagues. The idea of configuring which stats to track *per user* fit more naturally into **ItemTracking**, making the system more flexible and reusable.
- Learned to design and trigger syncs properly, connecting authentication events with background updates — a great exercise in event-driven design and mapping the user journey.
...
- Used Copilot agent effectively for the first time. It accelerated routine coding but required careful debugging since it occasionally missed subtle logic errors. It was especially helpful for Vue and front-end development, where I had little prior experience.
...
- Recognized that building reliable systems requires balancing automation (through LLMs) with deliberate, thoughtful design decisions.
- Learned a lot about front-end structure and interaction, especially how clear concepts help determine which features to build and how best to integrate them.
