...
content_id: af488a41a753562ff34c6418030574eb86d1ca47e8d88825b82937b4b37622a0
---
...
Deno.test("Principle: user registers, authenticates, changes password, and deletes account", async () => {
...
Deno.test("Action: register prevents duplicates", async () => {
...
Deno.test("Action: authenticate enforces correctness", async () => {
...
Deno.test("Action: changePassword enforces requirements", async () => {
...
Deno.test("Action: deleteAccount enforces correctness", async () => {
...
Deno.test("Query: _getUserByUsername and _checkPassword work as expected", async () => {
